...
ALTER TABLE `SESSION` ADD CHECK (`SESSION_FEE` >= 0.00);
ALTER TABLE `JOB_HISTORY` ADD CHECK (`TOTAL_HOURS` >= 0);
ALTER TABLE `PLACEMENT` ADD CHECK (`TOTAL_HOURS` >= 0);
ALTER TABLE `OPENING` ADD CHECK (`HOURLY_PAY` >= 0.00);
ALTER TABLE `OPENING` ADD CHECK (`NUM_OF_POSITIONS` > 0);
